...
$(document).ready(function () {
    ...
    $("#addQuestion").click(function (e) {
        let html = `<div class="mt-5 border">
                    ...
                    <div class="m-2">
                     ...
                     <div class="choice-container m-2" aria-value="${counter}"></div>
    ...
    $(document).on('click', 'div.add-choice', function () {
        ...
        let html = ` <div class="input-group my-2">
                            ...
                            <input type="text" class="form-control option-input" value="Option" autocomplete="off" name="questionChoice[]" onclick="this.select();">
